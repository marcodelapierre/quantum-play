...
escf = qbvqe(n_parameters*[0.0]) #get HF energy from initial guess
theta = np.array(n_parameters*[0.0])
theta = [-0.273461,0.358555,-0.821802,0.766661,-0.345868,-0.58924,-0.130962]
res = minimize(qbvqe, 
               theta, 
               method = 'SLSQP', 
