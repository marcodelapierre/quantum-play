...
mpb = [ConfigurationStateFunction.from_str({"0+0-1+1-2+2-" : 1.0}),
       ...
       ConfigurationStateFunction.from_str({"0+0-2+6-" : 1.0/math.sqrt(2.0), 
                                            "0+0-2-6+" : -1.0/math.sqrt(2.0)}),
       ConfigurationStateFunction.from_str({"0+0-1+1-7+7-" : 1.0}),
       ConfigurationStateFunction.from_str({"0+0-2+7-" : 1.0/math.sqrt(2.0), 
                                            "0+0-2-7+" : -1.0/math.sqrt(2.0)}),
       ConfigurationStateFunction.from_str({"0+0-1+1-8+8-" : 1.0}),
       ConfigurationStateFunction.from_str({"0+0-2+8-" : 1.0/math.sqrt(2.0), 
                                            "0+0-2-8+" : -1.0/math.sqrt(2.0)})]
