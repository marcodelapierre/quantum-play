#!/bin/bash -l
#SBATCH --job-name=install-pennylane-source-cuda-garrawarla
...
. $script_dir/use-pennylane-source-cuda-garrawarla.sh
...
pip install --prefix=$install_dir pytest mpi4py ninja
